                        ...
                        {currentUsers.map(user => {
                            return (
                                <tr key={user._id} className="text-capitalize">
                                    ...
                                    <td>
                                        <button className="btn btn-light text-danger" onClick={() => this.deleteUser(user._id)}>
        ...
        return (
            <div className="grid-container">
                ...
                <div className="ml-4 mt-5">
                    <label>show:</label>
                    <select className="userPerPage" id="userPerPage" onChange={e => this.setState({ usersPerPage: e.target.value, currentPage: 1 })}>
                    ...
                    <ul className="pagination">
                        ...
                        {pageNumbers.map(number => (
                            <li key={number} className="mt-3">
                                <a
                                    className={number === currentPage ? "page-link-active" : "page-link-inactive"}
                        ...
                        <p>&nbsp;</p>
                        <button
                            className={users.length > currentPage * usersPerPage ? "active-button" : "disable-button"}
                            onClick={() => this.setState({ currentPage: currentPage + 1 })}>
                            Next
                        </button>
                    </ul>
